...
import de.nrw.hbz.regal.MyMapping;
...
public class MyTest {
	...
	public void mainTest() throws URISyntaxException {
		...
		Main.main(new String[] { "--mode", "INIT", "--user", user, "--password", password, "--dtl", downloadlocation,
				"-cache", localcache, "--oai", oailocation, "--set", oaiset, "--timestamp", oaitimestamp,
				"--fedoraBase", fedoraUrl, "--host", "http://localhost", "-list", pidlist, "-namespace", "test" });
